...
public class HotelListState extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        stmt=con.createStatement();
                ...
                String query = "SELECT * FROM hotel WHERE state='"+state+"'";
                ...
                request.getRequestDispatcher("hotelListState.jsp").forward(request, response);
